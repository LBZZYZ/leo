...
QT_MOC_LITERAL(1, 7, 9), // "SendTcpRQ"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 11), // "const char*"
QT_MOC_LITERAL(4, 30, 9), // "SendUdpRQ"
QT_MOC_LITERAL(5, 40, 13), // "MatchPassword"
QT_MOC_LITERAL(6, 54, 12), // "MatchAccount"
QT_MOC_LITERAL(7, 67, 8), // "Register"
QT_MOC_LITERAL(8, 76, 15) // "MathPhoneNumber"

    },
    "Signup\0SendTcpRQ\0\0const char*\0SendUdpRQ\0"
    "MatchPassword\0MatchAccount\0Register\0"
    "MathPhoneNumber"
};
...
void Signup::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->MatchPassword(); break;
        case 3: _t->MatchAccount(); break;
        case 4: _t->Register(); break;
        case 5: _t->MathPhoneNumber(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Signup::*)(const char * , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Signup::SendTcpRQ)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Signup::*)(const char * , int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Signup::SendUdpRQ)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Signup::SendTcpRQ(const char * _t1, int _t2)
{
...
// SIGNAL 1
void Signup::SendUdpRQ(const char * _t1, int _t2, int _t3)
{
