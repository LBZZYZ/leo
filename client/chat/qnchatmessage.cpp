...
QNChatMessage::QNChatMessage(QWidget *parent) : QWidget(parent)
{
	...
	m_leftPixmap = QPixmap("chat/img/Customer Copy.png");

	m_rightPixmap = QPixmap("chat/img/CustomerService.png");

	m_loadingMovie = new QMovie(this);
	m_loadingMovie->setFileName("chat/img/loading4.gif");
...
QSize QNChatMessage::fontRect(QString str)
{
	...
	m_iconRightRect = QRect(781 - iconSpaceW - iconWH, iconTMPH, iconWH, iconWH);
